...
# Concessional loan schemes for the Scheduled Caste population, routed through
# the Channel Finance System (SCAs / PSBs / RRBs / NBFC-MFIs). Values are
# indicative and aligned to the problem statement (income ceiling ₹5L,
# coverage up to 90%, concessional ~6.5-8% p.a., moratorium 3-12 months).
CONCESSIONAL_SCHEMES = [
    {
        "name": "Micro Finance Scheme for Scheduled Castes",
        "short_name": "Micro Finance",
        "government_level": "central",
        "department": "Ministry of Social Justice & Empowerment (NSTFDC)",
        "description": "Concessional micro finance support for small SC entrepreneur projects up to ₹1.4 lakh, covering up to 90% of project cost at a concessional interest rate.",
        "sectors": ["all"],
        "states": ["all"],
        "business_stages": ["planning", "existing"],
        "support_types": ["loan"],
        "entrepreneur_types": ["sc"],
        "benefits": ["Concessional micro finance loan", "Coverage up to 90% of project cost", "Low concessional interest rate"],
        "eligibility": [
            "Applicant must belong to the Scheduled Caste (SC) category",
            "Annual family income up to ₹5,00,000",
            "Project cost up to ₹1,40,000",
            "Loan routed through a Channel Partner (SCA/PSB/RRB/NBFC-MFI)",
        ],
        "documents": ["Aadhaar Card", "Caste Certificate (SC)", "PAN Card", "Bank account details", "Project estimate/quotation"],
        "loan_min": 10000,
        "loan_max": 140000,
        "processing_days": 25,
        "loan_category": "micro_finance",
        "channel_financed": True,
        ...
        "official_url": "https://nsfdc.gov.in",
        "application_url": "https://nsfdc.gov.in",
    },
    {
        "name": "Term Loan Scheme for Scheduled Castes",
        "short_name": "SC Term Loan",
        "government_level": "central",
        "department": "Ministry of Social Justice & Empowerment (NSTFDC)",
        "description": "Concessional term loan for larger SC entrepreneur projects up to ₹50 lakh, covering up to 90% of project cost with a longer moratorium and tenure.",
        "sectors": ["all"],
        "states": ["all"],
        "business_stages": ["planning", "existing", "expanding"],
        "support_types": ["loan"],
        "entrepreneur_types": ["sc"],
        "benefits": ["Concessional term loan", "Coverage up to 90% of project cost", "Long tenure with moratorium on repayments"],
        "eligibility": [
            "Applicant must belong to the Scheduled Caste (SC) category",
            "Annual family income up to ₹5,00,000",
            "Project cost up to ₹50,00,000",
            "Loan routed through a Channel Partner (SCA/PSB/RRB/NBFC-MFI)",
        ],
        "documents": ["Aadhaar Card", "Caste Certificate (SC)", "PAN Card", "Bank account details", "Detailed project report"],
        "loan_min": 100000,
        "loan_max": 5000000,
        "processing_days": 40,
    ...
    {
        "name": "Educational Loan Scheme for SC Students",
        "short_name": "SC Education Loan",
        "government_level": "central",
        "department": "Ministry of Social Justice & Empowerment (NSTFDC)",
        "description": "Concessional educational loan for SC students pursuing higher studies and professional courses, covering up to 90% of education costs.",
        "sectors": ["education"],
        "states": ["all"],
        "business_stages": ["planning"],
        "support_types": ["loan"],
        "entrepreneur_types": ["sc", "youth"],
        "benefits": ["Concessional education loan", "Coverage up to 90% of education costs", "Moratorium covers course duration"],
        "eligibility": [
            "Applicant must belong to the Scheduled Caste (SC) category",
            "Annual family income up to ₹5,00,000",
            "Admission in a recognised higher-education / professional course",
            "Loan routed through a Channel Partner (SCA/PSB/RRB/NBFC-MFI)",
        ],
        "documents": ["Aadhaar Card", "Caste Certificate (SC)", "PAN Card", "Bank account details", "Admission letter and fee structure"],
        "loan_min": 50000,
        "loan_max": 1000000,
        "processing_days": 20,
    ...
    {
        "name": "Mahila Samridhi Yojana (SC Women)",
        "short_name": "Mahila Samridhi",
        "government_level": "central",
        "department": "Ministry of Social Justice & Empowerment (NSTFDC)",
        "description": "Micro finance support for Scheduled Caste women entrepreneurs starting small income-generating activities, with concessional terms.",
        "sectors": ["all"],
        "states": ["all"],
        "business_stages": ["planning", "existing"],
        "support_types": ["loan"],
        "entrepreneur_types": ["sc", "woman"],
        "benefits": ["Micro finance for SC women", "Concessional interest rate", "Coverage up to 90% of project cost"],
        "eligibility": [
            "Applicant must be a Scheduled Caste (SC) woman",
            "Annual family income up to ₹5,00,000",
...
def scheme_count() -> int:
    return len(SCHEMES) + len(CONCESSIONAL_SCHEMES)
